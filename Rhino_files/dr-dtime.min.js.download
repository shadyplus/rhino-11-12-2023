...
(function ($) {
 var rStartMiliseconds = $.cookie("randDate")
  ? $.cookie("randDate")
  : (new Date).getTime() - 29 * 24 * 60 * 60 * 1e3;
 if (!$.cookie("randDate"))
  $.cookie(
   "randDate",
   (new Date).getTime() - 29 * 24 * 60 * 60 * 1e3,
  ...
  rdate: function () {
   return this.each(function (x) {
    ...
    var nextDate = new Date(
     rStart.getTime() + z * (12 + z) * (60 + x) * 60 * (1e3 + x)
    );
    if (x >= 31)
     nextDate = new Date(parseInt(rStartMiliseconds) + 24946e5 + x * 15e4);
    ...
    if (nsec < 10)
     nsec = "0" + nsec;
    $(this).html(
     ndate + "." + nmonth + "." + nyear + " - " + nhour + ":" + nminutes
    )
   })
  },
  ryear: function () {
 ...
 $.fn.randDate = function (method) {
  if (methods[method]) {
   ...
   $.error(
    "Method " + method + " does not exist for jQuery.randDate"
   )
  }
 }
})(jQuery);
...
days_localized = {
 ...
 km: [
  ...
  "áž…áŸáž“áŸ’áž’",
  "áž¢áž„áŸ’áž‚áž¶ážšáŸ",
  "áž–áž»áž’",
  "áž–áŸ’ážšáž ážŸáŸ’áž”áž·áŸ",
  "ážŸáž»áž€áŸ’ážš",
  "ážŸáŸ…ážšáŸ"
 ],
 zh: [
